...
ninja.data = [
  ...
  {%- if site.posts_in_search -%}
    {%- assign blog_in_nav = false -%}
    {%- for p in site.pages -%}
      {%- if p.permalink contains '/blog/' and p.nav -%}
        {%- assign blog_in_nav = true -%}
      {%- endif -%}
    {%- endfor -%}
    {%- if blog_in_nav -%}
  ...
  {%- for collection in site.collections -%}
    {%- if collection.label != 'posts' -%}
      {%- assign collection_in_nav = false -%}
      {%- for p in site.pages -%}
        {%- if p.permalink contains collection.label and p.nav -%}
          {%- assign collection_in_nav = true -%}
        {%- endif -%}
      {%- endfor -%}
      {%- if collection_in_nav -%}
